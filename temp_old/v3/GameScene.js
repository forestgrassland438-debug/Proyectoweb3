...
removeOtherPlayer(playerId) {
  ...
  _showRemoteChatBubble(playerId, text) {
    ...
    // Reutilizar o crear contenedor de burbuja en el mundo de Phaser (texto nativo)
    ...
    op._chatText = this.add.text(
      op.sprite.x,
      op.sprite.y - sprH * 0.5 - 28,
      display,
      {
        fontFamily: '"PressStart2P"',
        fontSize: '8px',
        color: '#d0eaff',
        backgroundColor: 'rgba(10,20,50,0.88)',
        padding: { x: 6, y: 4 },
        wordWrap: { width: 160 },
        stroke: '#001030',
        strokeThickness: 2,
  ...
  /** Muestra/oculta los dots de typing sobre un jugador remoto */
  _showRemoteTypingBubble(playerId, show) {
    ...
    const sprH = op.sprite.displayHeight || 64;
    op._chatTypingText = this.add.text(
      op.sprite.x,
      op.sprite.y - sprH * 0.5 - 22,
      '...', // simple dots — Phaser no soporta animación CSS
      {
        fontFamily: '"PressStart2P"',
        fontSize: '10px',
        color: '#40a0ff',
        backgroundColor: 'rgba(10,20,50,0.80)',
        padding: { x: 6, y: 3 },
        resolution: 4,
      }
    ).setOrigin(0.5, 1).setDepth(op.sprite.depth + 10);

    // Auto-ocultar después de 3s si no hay más eventos
